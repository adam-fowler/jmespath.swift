...
internal struct JSONWriter {
    ...
    init(options: JSONOutputFormatting) {
    ...
    mutating func serializeStringContents(_ str: String) -> Int {
        ...
        mutStr.withUTF8 {
            ...
            while cursor < end {
                ...
                case 0x0...0xf:
                    appendAccumulatedBytes(
                        from: mark,
                        to: cursor,
                        followedByContentsOf: [._backslash, UInt8(ascii: "u"), UInt8(ascii: "0"), UInt8(ascii: "0"), UInt8(ascii: "0")]
                    )
                ...
                case 0x10...0x1f:
                    appendAccumulatedBytes(
                        from: mark,
                        to: cursor,
                        followedByContentsOf: [._backslash, UInt8(ascii: "u"), UInt8(ascii: "0"), UInt8(ascii: "0")]
                    )
